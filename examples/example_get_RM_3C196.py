...
plot_date(mydatetimes[2::4],rtec2-dataMB2[:,1]-np.average(rtec2-dataMB2[:,1]),'b-')
plot_date(mydatetimes[2::4],rtec-dataMB2[:,1]-np.average(rtec-dataMB2[:,1]),'g-')
plot_date(mydatetimes[2::4],rtec3-dataMB2[:,1]-np.average(rtec3-dataMB2[:,1]),'r-')
legend(['ILTG','ILTQ','IGSG'])
ylabel("RM rad/m^2")
