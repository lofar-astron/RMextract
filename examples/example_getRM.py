...
starttime = (
    t.mjd * 24 * 3600.0
)  # getRM still wants MJD time in seconds (casacore definition)
endtime = starttime + 3600.0  # one hour of data
statpos = [
    3826577.1095,
    461022.900196,
    5064892.758,
]  # LOFAR CS002LBA (center) , ITRF xyz in meters
...
for tm, rm in zip(times, RM):
    print("%5.2f        %1.3f" % (tm / (3600 * 24.0), rm))
