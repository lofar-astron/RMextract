...
tec=gt.getTEC(ionexPath='./IONEXdata',radec=[ra,dec],timestep=300, timerange = [a, b],stat_positions=[statpos,],ha_limit=np.pi,server="ftp://gnss.oma.be/gnss/products/IONEX/",prefix="ROBR")
