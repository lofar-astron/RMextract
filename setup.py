...
if "--add-iri" in sys.argv:
    ...
    ext.append(Extension2('_iriplas',sources=['pyiriplas/iriplas.pyf','pyiriplas/igrf.for','pyiriplas/irif2019.for','pyiriplas/iriplas_main.for','pyiriplas/Iris2017.for','pyiriplas/indx2017.for'],include_dirs=[numpy.get_include()]))
