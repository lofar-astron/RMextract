...
class pyiri:
    def __init__(self, year=2016, month=5, day=12, hour=1.0, lon=0.0, lat=0.0):
        self.lon = lon
        self.lat = lat
        self.yr = year
        self.month = month
        ...
        self.datapath = resource_filename(__name__, "ig_rz.dat").replace(
            "ig_rz.dat", ""
        )
