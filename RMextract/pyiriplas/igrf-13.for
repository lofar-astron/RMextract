C igrf-13 (2020) version............................................Oct 2020
C
...
c-----------------------------------------------------------------------        
C-      COMMON/IGRF1/     UMR,ERA,AQUAD,BQUAD	  !?
C
      COMMON /CONST/UMR,PI					  
C      CALL INITIZE                               !+
            xyear=year
...
c 667    FORMAT('/var/www/omniweb/cgi/vitmo/IRI/',A13)
        OPEN (IU, FILE=TRIM(ADJUSTL(DATAPATH))//FOUT, STATUS='OLD',
     &      IOSTAT=IER, ERR=999)     
...
C **********************************************************************
      ...
      LOGICAL mess
      PARAMETER CON=1.4
      PARAMETER CCON2=CON*CON
      PARAMETER CBIG=1.E30
      PARAMETER CNTAB=10
      PARAMETER CSAFE=2.
      EXTERNAL func
...
C--------------------------------------------------------------------------
       INTEGER IYYYY,DDD
       REAL XM(3),YM(3),ZM(3)
C       REAL YR(10),MX(10),MY(10),MZ(10)
C       REAL INTERP,YEAR
